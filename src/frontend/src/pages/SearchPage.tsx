...
export default function SearchPage() {
  ...
  const filtered = useMemo(() => {
    ...
    return all.filter((p) => {
      ...
      return matchCity && matchRoom && matchPrice;
    });
  }, [properties, cityFilter, roomTypeFilter, maxPrice]);
  ...
  return (
    <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      {/* Filters */}
      {showFilters && (
        <div className="bg-card border border-border rounded-xl p-5 mb-6 grid grid-cols-1 sm:grid-cols-3 gap-5">
          <div className="space-y-2">
            ...
            <Select value={roomTypeFilter} onValueChange={setRoomTypeFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value={Variant_apartment_sharedRoom_single.single}>
                  Single Room
                </SelectItem>
              </SelectContent>
            </Select>
